    ...
    return (
        <div className='min-h-screen flex flex-col lg:flex-row items-center justify-between gap-12 px-4 lg:px-8'>
            ...
            <div className='flex-1 flex justify-center lg:justify-end order-1 lg:order-2 relative'>
                ...
                <div className='absolute top-10 right-10 w-4 h-4 bg-blue-500 rounded-full animate-bounce delay-1000'></div>
                <div className='absolute bottom-20 left-10 w-3 h-3 bg-purple-500 rounded-full animate-bounce delay-500'></div>
                <div className='absolute top-1/2 left-0 w-2 h-2 bg-green-500 rounded-full animate-pulse'></div>
            </div>
        </div>
    )
}
